...
Accounts/cloud sync; mobile layouts (<1024px gets a "desktop + MIDI required" notice with read-only curriculum browsing); microphone input; MusicXML import; velocity/dynamics grading (velocity is _recorded_, not graded); social features; monetization.
