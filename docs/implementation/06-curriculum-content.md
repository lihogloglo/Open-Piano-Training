...
| s6.u8 | The unseen chart                   | Graded: a _generated_ chart (diatonic+7ths, familiar forms) never seen before, 2 passes allowed, styled comp ≥0.8. Atom `skill:sightcomp` (this is also the `keys` rating's top material). |
